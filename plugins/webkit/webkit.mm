...
WebKit *WebKit::instance = NULL;

void WebKit::_bind_methods() {
    ClassDB::bind_method(D_METHOD("print_version"), &WebKit::print_version);
    ClassDB::bind_method(D_METHOD("open_auth_url", "url"), &WebKit::open_auth_url);
}
